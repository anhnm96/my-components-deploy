const __vite__fileDeps=["assets/default-Dyr5jqwl.js","assets/vendor-Cr-HhYtu.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { bx as useNuxtApp, by as hasInjectionContext, aZ as inject, bz as withQuery, bA as hasProtocol, bB as toRef, bC as createError$1, bD as $fetch$1, b6 as getCurrentInstance, bE as parse, bF as defineNuxtPlugin, bG as executeAsync, bH as shallowRef, bI as destr, at as ref, bJ as shallowReactive, b4 as reactive, bK as withoutBase, bL as useRuntimeConfig, av as computed, aD as defineComponent, bM as h, bN as isReadonly, bO as isEqual, bP as stringifyParsedURL, bQ as stringifyQuery, bR as parseURL, bS as parseQuery, bT as joinURL, bU as LazyIcon, bV as LazyIconCSS, bW as createConsola, bX as consola, _ as __vitePreload, bY as unhead_eyEy7315Kx, as as _export_sfc, aw as openBlock, ax as createBlock, ba as normalizeProps, bb as guardReactiveProps, R as defineAsyncComponent, a_ as provide, bZ as onErrorCaptured, ay as withCtx, aC as resolveDynamicComponent, b_ as Suspense, b$ as onServerPrefetch, c0 as createSSRApp, bs as createApp, c1 as createNuxtApp, c2 as applyPlugins, b2 as nextTick } from "./vendor-Cr-HhYtu.js";
import { b as baseURL } from "./paths-DTQIdwRl.js";
...
const layouts = {
  default: () => __vitePreload(() => import("./default-Dyr5jqwl.js"), true ? __vite__mapDeps([0,1]) : void 0).then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const _Error404 = defineAsyncComponent(() => __vitePreload(() => import("./vendor-Cr-HhYtu.js").then((n) => n.c7), true ? [] : void 0).then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => __vitePreload(() => import("./vendor-Cr-HhYtu.js").then((n) => n.c8), true ? [] : void 0).then((r) => r.default || r));
