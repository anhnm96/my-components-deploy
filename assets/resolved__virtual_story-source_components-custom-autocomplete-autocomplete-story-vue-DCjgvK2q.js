const resolved__virtual_storySource_componentsCustomAutocompleteAutocompleteStoryVue = `<script lang="ts" setup>
const countries = [
  'Afghanistan',
  'Albania',
  'Algeria',
...
`;
export {
  resolved__virtual_storySource_componentsCustomAutocompleteAutocompleteStoryVue as default
};
